...
public class AvisBudgetParser {
    ...
    public static void main(String[] args) {
        ...
        List<Car_Info> combinedCarInfoList = new ArrayList<>();
...
//                        System.out.println(file.getName());
    ...
    public static List<Car_Info> parseFiles() {
        List<Car_Info> combinedCarInfoList = new ArrayList<>();
...
//        saveCarInfoToJson(combinedCarInfoList, "filtered_car_deals");
    ...
    private static List<Car_Info> parseCarRentalWebsite(String filePath) {
        List<Car_Info> carInfoList = new ArrayList<>();
...
//                System.out.println(carElement.select("span.four-seats-feat").text());
                ...
                Car_Info carInfo = new Car_Info(carName, carPrice, passengerCapacity, carGroup, transmissionType, largeBag, smallBag, rentalCompany);
    ...
    private static void saveCarInfoToJson(List<Car_Info> carInfoList, String filename) {
