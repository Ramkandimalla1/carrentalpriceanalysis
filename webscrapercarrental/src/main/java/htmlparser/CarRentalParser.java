...
public class CarRentalParser {
    ...
    public static List<Car_Info> fetchAllCarRentalDeals(){
...
//        }
    ...
    public static void main(String[] args) {
        ...
        // Parse and extract car information from both websites
        List<Car_Info> carInfoList1 = parseCarRentalWebsite(website1Path);
    }
...
//                System.out.println(smallBag);
                ...
                Car_Info carInfo = new Car_Info(carName, carPrice, passengerCapacity, carGroup, transmissionType, largeBag, smallBag, "CarRental");
